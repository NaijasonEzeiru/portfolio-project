...
const Login = () => {
	...
	return (
		<div className='bg-white rounded-lg shadow-md text-black py-12 my-8 px-3 m-3 text-center flex gap-11 flex-col dark:bg-secondary dark:text-white md:mx-14 md:px-16 lg:mx-32'>
